...
export default function Home() {
  ...
  return (
    <div className={`w-full min-h-screen flex flex-col font-sans ${theme === 'light' ? 'bg-white' : 'bg-background'} text-foreground`}>
      ...
      <section
        ...
        style={{ position: 'relative', background: theme === 'light' ? '#fff' : '#010101' }}
      >
      ...
      <section className="scroll-mt-24 md:hidden">
        <div className={`w-full flex flex-col gap-10 py-8 ${theme === 'light' ? 'bg-white' : 'bg-background'}`}> 
      ...
      <motion.section
        ...
        className={`w-full flex flex-col items-center justify-center py-24 md:py-40 px-4 relative overflow-hidden scroll-mt-24 ${theme === 'light' ? 'bg-white' : 'bg-background'}`}
        style={{ background: theme === 'light' ? '#fff' : '#010101' }}
        initial="offscreen"
        whileInView="onscreen"
        exit="exit"
      ...
      >
        ...
        <div className="relative z-10 w-full max-w-3xl flex flex-col items-start">
          <h2 className={`font-black text-3xl md:text-6xl leading-tight text-left mb-6 ${theme === 'light' ? 'text-neutral-900' : 'text-accent'}`}>
          ...
          <p className={`text-lg md:text-2xl font-light mb-10 max-w-xl ${theme === 'light' ? 'text-neutral-700' : 'text-neutral-400'}`}>
          ...
          <div className="flex gap-4 mt-8">
            ...
            <a href="https://www.linkedin.com/in/venkateshr2006/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"
              ...
              <span className="butter-content flex items-center gap-3">
                <svg
                  className={`w-7 h-7 text-accent transition-colors duration-200 group-hover:${theme === 'light' ? 'text-black' : 'text-white'}`}
                ...
                <div className="flex flex-col">
                  <span className={`font-bold leading-tight transition-colors duration-200 group-hover:${theme === 'light' ? 'text-black' : 'text-white'}`}>LinkedIn</span>
            ...
            <a href="https://www.instagram.com/vvenkyy_/" target="_blank" rel="noopener noreferrer" aria-label="Instagram"
              ...
              <span className="butter-content flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  <span className="font-bold group-hover:text-white leading-tight transition-colors duration-200">Instagram</span>
            ...
            <a href="https://www.fiverr.com/s/bdwvvrm" target="_blank" rel="noopener noreferrer" aria-label="Fiverr"
              ...
              <span className="butter-content flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  <span className="font-bold group-hover:text-white leading-tight transition-colors duration-200">Fiverr</span>
                  <span className={`text-xs group-hover:text-white transition-colors duration-200 ${theme === 'light' ? 'text-neutral-500' : 'text-neutral-400'}`}>@vvenkyy_</span>
                </div>
              </span>
            </a>
...
function StepRevealServices({ servicesSectionRef }: StepRevealServicesProps) {
  ...
  return (
    <div className={`w-full min-h-[60vh] flex flex-col md:flex-row scroll-mt-24 py-8 md:py-12 ${theme === 'light' ? 'bg-white' : 'bg-background'}`}>
      <div id="services" ref={servicesSectionRef} />
      {/* Left: Stacked Service List */}
      <div className="md:w-[38.2%] w-full flex flex-col justify-center sticky top-24 h-[60vh] z-20 pl-4 md:pl-10 select-none">

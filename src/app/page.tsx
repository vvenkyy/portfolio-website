          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mt-4 md:mt-8 w-full max-w-sm sm:max-w-none">
            ...
            <a href="https://www.linkedin.com/in/venkateshr2006/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"
              ...
              <span className="butter-content flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  <span className={`font-bold leading-tight text-sm sm:text-base transition-colors duration-200 group-hover:${theme === 'light' ? 'text-black' : 'text-white'}`}>LinkedIn</span>
            ...
            <a href="https://www.instagram.com/vvenkyy_/" target="_blank" rel="noopener noreferrer" aria-label="Instagram"
              ...
              <span className="butter-content flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  <span className="font-bold group-hover:text-white leading-tight text-sm sm:text-base transition-colors duration-200">Instagram</span>
            ...
            <a href="https://www.fiverr.com/s/bdwvvrm" target="_blank" rel="noopener noreferrer" aria-label="Fiverr"
              ...
              <span className="butter-content flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  <span className="font-bold group-hover:text-white leading-tight text-sm sm:text-base transition-colors duration-200">Fiverr</span>
                  <span className={`text-xs group-hover:text-white transition-colors duration-200 ${theme === 'light' ? 'text-neutral-500' : 'text-neutral-400'}`}>@vvenkyy_</span>
                </div>
              </span>
            </a>
